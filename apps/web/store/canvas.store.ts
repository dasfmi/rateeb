...
} from "@/ui/canvas/camera-utils";
import { CAMERA_ANGLE, RECT_H, RECT_W } from "@/ui/canvas/constants";
// import { radians } from "@/ui/canvas/utils";
...
export default class CanvasStore {
    ...
    static initialize(width: number, height: number) {
        ...
        canvasData.camera.z = containerWidth / (2 * Math.tan(0));
    }
